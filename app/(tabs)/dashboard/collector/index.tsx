    ...
    return (
        <>
            <ScrollView className=" bg-primary">
                ...
                <View className="mt-5 bg-white shadow-lg p-2 w-[90%] mx-auto rounded-xl">
                    <View className="border-b border-blue-500">
                        <Text className="text-2xl text-center font-bold pb-2">
                    ...
                    <View className="flex-row justify-between mt-4">
                        <View className="flex-1 pl-2 gap-2">
                            <View className="flex-row justify-between w-full border-b border-b-gray-400 p-4">
                                <Text className="text-lg"> Location Code:</Text>
                                <Text className="text-lg">
                                    {" "}
                                    No. 13,millawa road, Horana
                                </Text>
                            </View>
                            <View className="flex-row justify-between w-full border-b border-b-gray-400 p-4">
                                <Text className="text-lg">
                                ...
                                <Text className="text-lg"> Truck</Text>
                            </View>
                            <View className="flex-row justify-between w-full border-b border-b-gray-400 p-4">
                                <Text className="text-lg"> Vehicle ID:</Text>
                                <Text className="text-lg"> AB 1230</Text>
                            </View>
                        </View>
                    </View>
                </View>
                ...
                <View className="px-5 mt-6">
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            router.push("/(tabs)/dashboard/collector/QRScanner")
                        }
                    >
                        <Text className="text-white text-2xl text-center font-semibold w-full">
                            Scan QR
                        </Text>
                    </TouchableOpacity>
                </View>
                ...
                <View className="px-5 ">
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            router.push(
                                "/(tabs)/dashboard/collector/AddCollector"
                            )
                        }
                    >
                        <Text className="text-white text-2xl text-center font-semibold w-full">
                ...
                <View className="px-5 mb-5">
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            router.push(
                                "/(tabs)/dashboard/collector/QRCode"
                            )
                        }
                    >
                        <Text className="text-center text-white text-2xl font-semibold p-1 w-full">
                            Generate QR
                        </Text>
                    </TouchableOpacity>
                </View>

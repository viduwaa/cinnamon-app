...
export default function Farmer() {
  ...
  return (
    ...
    >
      <ScrollView className="flex-1 bg-gray-100">
        ...
        <View className="flex-row justify-between items-center px-5 pt-4 pb-5 bg-gray-100">
          <View className="flex-row items-center flex-1">
            <Image
              source={require('./fghhj.png')}
              className="w-12 h-12"
            />
            <Text className="text-xl font-bold text-amber-900 ml-5">Farmer</Text>
          </View>
        ...
        <View className="flex-row items-center bg-white mx-5 mt-3 p-4 rounded-3xl shadow-lg">
          <View 
            className="mr-4 border-4 border-blue-500 rounded-3xl p-1"
          >
            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=240&fit=crop&crop=face' }}
              style={{ 
          ...
          <View className="flex-1 justify-center">
            <Text className="text-lg font-bold text-gray-800 mb-2">Isuru Madusanka</Text>
            <View className="flex-row items-center mb-1">
              <View className="w-4 h-4 rounded-full bg-black justify-center items-center mr-2">
                <Text className="text-xs text-white">📍</Text>
              </View>
              <Text className="text-base text-gray-600 font-medium">Matale</Text>
            </View>
          </View>
        ...
        <View className="bg-white mx-5 mt-6 rounded-2xl p-5 shadow-lg">
          <View className="flex-row justify-between items-center mb-1">
            <Text className="text-base font-bold text-gray-800">Plantings</Text>
            <View className="flex-row flex-1 justify-center gap-5">
              ...
              <View className="border border-gray-300 rounded-sm bg-gray-50">
                <Picker
                  ...
                  onValueChange={(itemValue) => setSelectedLand(itemValue)}
                >
                  <Picker.Item label="Land ▼" value="" />
                  <Picker.Item label="Field A" value="land1" />
                  <Picker.Item label="Field B" value="land2" />
                  <Picker.Item label="Field C" value="land3" />
                </Picker>
              </View>
            </View>
            <Text className="text-sm text-gray-600">01</Text>
          </View>
          <Text className="text-sm text-gray-600 mb-4 text-center">Cultivation</Text>
          ...
          <View className="items-center">
            ...
            >
              <Text className="text-sm text-gray-800 font-semibold">Quantity(kg)</Text>
            </View>
            <View 
            ...
            <View className="mt-3 items-center">
              <Text className="text-sm text-gray-800 font-semibold">Weeks</Text>
            </View>
          </View>
        </View>
        ...
        <View className="px-5 mt-6">
          <TouchableOpacity 
            ...
            onPress={() => router.push("./addFarmer")}
          >
            <Text className="text-white text-sm font-semibold text-justify">Add Farmer Information</Text>
          ...
          <TouchableOpacity className="bg-amber-900 flex-row justify-between items-center ml-10 w-4/5 p-4 rounded-lg mb-4 shadow-md">
            <Text className="text-white text-sm font-semibold text-justify">Add Batch Information</Text>
            <Text className="text-white text-lg font-bold">→</Text>
          </TouchableOpacity>

          <TouchableOpacity className="bg-amber-900 flex-row justify-between items-center ml-10 w-4/5 p-4 rounded-lg mb-4 shadow-md">
            <Text className="text-white text-sm font-semibold text-justify">Add Harvesting Information</Text>
            <Text className="text-white text-lg font-bold">→</Text>
          </TouchableOpacity>

          <TouchableOpacity className="bg-amber-900 w-4/5 ml-10 mb-12 rounded-lg items-center shadow-md pt-4 h-12">
            <Text className="text-white text-sm font-semibold p-1">Generate QR</Text>
          </TouchableOpacity>
        </View>
      ...
      {/* Bottom Navigation */}
      <View 
        className="flex-row justify-around items-center bg-green-400 mx-5 py-4 rounded-3xl shadow-lg"
        style={{ 
          position: 'fixed',
          bottom: 30,
          left: 0,
